        ...
        <div className="mt-8">
          <div className="max-w-7xl px-5 sm:px-10  mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <table className="shadow mt-2 w-full divide-y divide-cool-gray-200 table-fixed">
              <thead>
                <tr>
                  <th className="sm:w-1/2 px-6 py-3 bg-gray bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                    Title
                  </th>
                  ...
                  {"sa" === currentUser.role && (
                    <th className="px-6 py-3 bg-gray-50 text-right text-xs leading-4 font-medium text-cool-gray-500 uppercase tracking-wider">
                      Platform
                    </th>
                  )}
