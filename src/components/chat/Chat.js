...
const Chat = ({ content }) => {
  ...
  return (
    <>
      {!!currentUser ? (
        <>
          <div style={{ overflow: "auto" }} className="px-5 pt-5" id="chatMessages">
        ...
        <div className="p-5 flex flex-1 flex-col items-center justify-center text-gray-700 bg-opacity-0 sm:bg-opacity-50 bg-black ">
          <svg
