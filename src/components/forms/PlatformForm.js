            ...
            <div className="grid grid-cols-1">
              <div className="col-span-3 sm:col-span-2">
                ...
                <div className="mt-1 flex rounded-md shadow-sm">
                  <div className="relative flex-1 border rounded-md rounder-r-0 border-r-0 border-grey-300">
                    <input
                      id="slug"
                      name="slug"
                      className={`${
                  ...
                  <span className="-ml-2 inline-flex items-center px-3 rounded-r-md border border-l-0 border-gray-300 bg-gray-50 text-cool-gray-500 text-sm">
                    .tribesocial.io
                  </span>
                </div>
            ...
            <div className="grid grid-cols-1">
              <div className="col-span-3 sm:col-span-2">
                ...
                <div className="mt-1 flex rounded-md shadow-sm">
                  ...
                  <div className="-ml-2 relative flex-1 rounded-md border rounded-l-0 border-l-0 border-grey-300">
                    <input
                      id="homepageUrl"
                      name="homepageUrl"
                      className={`${
            ...
            <div className="grid grid-cols-1">
              <div className="col-span-3 sm:col-span-2">
                ...
                <SmartSelect
                  ...
                  onChange={onChange}
                  name="timezone"
                  items={timezones.sort(e => (/Eastern/gi.test(e.text) ? -1 : 1)).map(e => e.text)}
                />
                {/* <select
                  value={(state && state.timezone) || ""}
                  onChange={onChange}
